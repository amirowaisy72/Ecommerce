        ...
        <div>
          ...
          <div className="main-wrapper">
            ...
            <Routes>
              ...
              <Route exact path="/products/addProduct" element={<AddProduct />}></Route>
              <Route exact path="/categories" element={<Categories />}></Route>
              <Route exact path="/categories/addCategory" element={<AddCategory />}></Route>
              <Route exact path="/orders" element={<Order />}></Route>
              <Route exact path="/orders/orderDetail" element={<OrderDetail />}></Route>
